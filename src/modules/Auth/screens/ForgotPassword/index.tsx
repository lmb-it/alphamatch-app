...
import type {IForgotPasswordForm, INewPasswordForm, Step} from '../../models/auth.form.types';
import {getRequestElements, getPasswordElements} from './forgotPassword.elements';
...
const ForgotPasswordScreen: React.FC = () => {
  ...
  const requestElements = useMemo(
    () => getRequestElements({t}),
    [t],
  );

  // ─── Step 3: New password form ───
  const passwordElements = useMemo(
    () => getPasswordElements({t}),
    [t],
  );
