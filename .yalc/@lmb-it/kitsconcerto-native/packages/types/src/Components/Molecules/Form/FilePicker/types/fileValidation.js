...
const fileValidation = (props = { min: 1, max: 1, acceptedTypes: "*", minSize: 0, maxSize: 5242880 }) => Yup.mixed().test("fileSizeMax", `File size should be less that ${convertSize(props.maxSize ?? 0)}`, (value) => {
