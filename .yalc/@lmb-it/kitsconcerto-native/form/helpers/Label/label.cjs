...
const Label = ({ label, className, isFormControl = false, elementId, required, style }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(index.FormControlLabel, { className: labelClasses, style: { padding: 0, ...style || {} }, children: /* @__PURE__ */ jsxRuntime.jsx(index.FormControlLabelText, { style: { padding: 0, ...style || {} }, children: renderLabel }) });
};
