...
const Label = ({ label, className, isFormControl = false, elementId, required, style }) => {
  ...
  return /* @__PURE__ */ jsx(FormControlLabel, { className: labelClasses, style: { padding: 0, ...style || {} }, children: /* @__PURE__ */ jsx(FormControlLabelText, { style: { padding: 0, ...style || {} }, children: renderLabel }) });
};
