...
const ErrorMessage = ({ errors, invalid, style }) => {
  ...
  const renderMessage = (message, index$1) => /* @__PURE__ */ jsxRuntime.jsxs(index.FormControlError, { style: style || void 0, children: [
    /* @__PURE__ */ jsxRuntime.jsx(index.FormControlErrorIcon, { as: lucideReactNative.AlertCircleIcon, className: "text-red-500" }),
    /* @__PURE__ */ jsxRuntime.jsx(index.FormControlErrorText, { className: "text-red-500", style: style || void 0, children: message })
  ] }, index$1);
  if (typeof errors === "string") {
    return renderMessage(errors);
  }
  if (Array.isArray(errors)) {
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: errors.map((err, i) => renderMessage(err, i)) });
  }
