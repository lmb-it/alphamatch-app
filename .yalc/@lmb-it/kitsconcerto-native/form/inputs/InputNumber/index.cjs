...
const KitsInputNumber = ({ ref, ...rawProps }) => {
  const { mergedProps: props, themeStyle, elementStyles } = useComponentDefaults.default("InputNumber", rawProps, "Input");
    ...
    index_native.default,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(
        index.Input,
        {
          ...
          isInvalid: !!invalid,
          ...rest,
          style: { width: "100%", ...resolvedRootStyle && Object.keys(resolvedRootStyle).length > 0 ? resolvedRootStyle : resolvedThemeStyle },
