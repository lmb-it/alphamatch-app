...
var Strengthen_native = require('./Strengthen.cjs');
...
const KitsInputPassword = ({ ref, ...rawProps }) => {
  ...
  const { inputRef, navProps } = useFormFieldKeyboardNav_native.useFormFieldKeyboardNav(id);
  ...
  const focusResolvedStyle = useFocusStyles_native.useFocusStyles(rootStyle, isFocused);
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          index.Input,
          {
            ...
            children: [
              ...
              toggleEye && /* @__PURE__ */ jsxRuntime.jsx(index.InputSlot, { onPress: toggleSecure, style: { paddingHorizontal: 12 }, children: secure ? eyeIcon ?? /* @__PURE__ */ jsxRuntime.jsx(index_native$1.Icon, { name: "eye" }) : eyeSlashIcon ?? /* @__PURE__ */ jsxRuntime.jsx(index_native$1.Icon, { name: "eye-slash" }) })
            ]
          }
        ),
        showStrengthProgress && schema && /* @__PURE__ */ jsxRuntime.jsx(
          Strengthen_native.default,
          {
            value: internal ?? "",
            show: false,
            schema
