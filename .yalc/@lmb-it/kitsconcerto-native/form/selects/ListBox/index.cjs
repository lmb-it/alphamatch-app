...
var index_native$1 = require('../../../layout/VStack/index.cjs');
var index_native$2 = require('../../../primitives/Text/index.cjs');

const KitsListBox = (rawProps) => {
  const { mergedProps: props, themeStyle, elementStyles } = useComponentDefaults.default("ListBox", rawProps, "Select");
    ...
    index_native.default,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(
        index.default,
        {
          ...
          style: resolvedRootStyle && Object.keys(resolvedRootStyle).length ? resolvedRootStyle : Object.keys(resolvedThemeStyle).length ? resolvedThemeStyle : void 0,
          children: [
