...
import MultiSelect from '../../../apps/mobile/src/Core/MultiSelect/index.js';
...
const KitsMultiSelect = ({ className, ref, ...rawProps }) => {
  const { mergedProps: props, themeStyle, elementStyles } = useComponentDefaults("MultiSelect", rawProps, "Input");
  ...
  const handleChange = useCallback((e, items) => {
  ...
  const Element = /* @__PURE__ */ jsx(
    MultiSelect,
    {
      ...
      style: { borderRadius: 0, ...resolvedRootStyle && Object.keys(resolvedRootStyle).length > 0 ? resolvedRootStyle : resolvedThemeStyle },
