...
var index$1 = require('../../../../apps/mobile/src/Core/Paginator/index.cjs');
...
var index_native = require('../index.cjs');
require('axios');
...
var index = require('../../../Molecules/UI/Box/index.cjs');
require('primereact/tooltip');
require('primereact/skeleton');

function Pagination() {
  const { paginationParams } = index_native.useDataView();
  return /* @__PURE__ */ jsxRuntime.jsx(index.default, { className: "card", children: /* @__PURE__ */ jsxRuntime.jsx(
    index$1.Paginator,
    {
