...
const KitsToast = ({ ref }) => {
  ...
  const toast = React.useCallback((severity, summary, body = "", position = "bottom-center", _isUpdate = false, size = "md") => {
  ...
  const dismiss = React.useCallback((position) => {
    setToasts((prev) => {
  ...
  React.useImperativeHandle(ref, () => ({ toast, dismiss, dismissAll }));
  React.useEffect(() => {
    return () => {
      timersRef.current.forEach((t) => clearTimeout(t));
    };
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: reactNative.StyleSheet.absoluteFill, pointerEvents: "box-none", children: toasts.map((item) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Animated.View,
      {
        entering,
        exiting,
        layout: Animated.Layout.duration(200),
        style: [
          styles.toastWrapper,
          {
            alignItems: align,
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(
          Animated.View,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { style: [styles.accentBar, { backgroundColor: accentColor, width: s.accentWidth }] }),
              /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: [styles.content, { paddingVertical: s.paddingV, paddingHorizontal: s.paddingH, gap: s.paddingH * 0.7 }], children: [
                item.severity === "loading" && /* @__PURE__ */ jsxRuntime.jsx(reactNative.ActivityIndicator, { size: "small", color: accentColor }),
                /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { style: styles.textContainer, children: [
                  /* @__PURE__ */ jsxRuntime.jsx(index_native.default, { style: { fontWeight: "600", fontSize: s.summarySize, color: textColor }, children: item.summary }),
                  !!item.body && /* @__PURE__ */ jsxRuntime.jsx(index_native.default, { style: { fontSize: s.bodySize, marginTop: 2, color: textColor, opacity: 0.7 }, children: item.body })
                ] }),
                /* @__PURE__ */ jsxRuntime.jsx(reactNative.Pressable, { onPress: () => removeToast(item.id), hitSlop: 8, children: /* @__PURE__ */ jsxRuntime.jsx(index_native.default, { style: { fontSize: s.closeSize, fontWeight: "bold", color: textColor, opacity: 0.4 }, children: "\u2715" }) })
              ] })
            ]
          }
        )
