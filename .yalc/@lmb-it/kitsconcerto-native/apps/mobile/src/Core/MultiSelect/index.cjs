...
function MultiSelect(props) {
  ...
  const renderSelected = () => {
    if (!selectedValues.length) {
      return /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: [styles.placeholder, { color: colors.placeholder }, externalTextStyle], children: placeholder });
    }
    if (display === "chip") {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { numberOfLines: 1, style: [styles.commaText, { color: colors.text }, externalTextStyle], children: selectedValues.slice(0, maxSelectedLabels).map((v) => getLabel(v, optionLabel)).join(", ") });
  };
