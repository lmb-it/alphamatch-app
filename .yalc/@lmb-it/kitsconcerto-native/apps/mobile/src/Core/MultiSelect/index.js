...
import { View, Text, TouchableOpacity, TextInput, Modal, Pressable, StyleSheet, ActivityIndicator, FlatList } from 'react-native';
...
function MultiSelect(props) {
  ...
  const renderCheckbox = (checked) => /* @__PURE__ */ jsx(
    View,
    {
      style: [
        styles.checkbox,
      ...
      children: checked && /* @__PURE__ */ jsx(Text, { style: styles.checkmark, children: "\u2713" })
    }
  );
  const renderListContent = () => {
    if (loading) {
      return /* @__PURE__ */ jsxs(View, { style: styles.loadingContainer, children: [
        /* @__PURE__ */ jsx(ActivityIndicator, { size: "small", color: colors.checkboxChecked }),
        /* @__PURE__ */ jsx(Text, { style: [styles.loadingText, { color: colors.placeholder }], children: "Loading..." })
      ] });
    }
    const itemsOnly = filtered.filter((e) => e.type === "item");
    if (itemsOnly.length === 0) {
      return /* @__PURE__ */ jsx(View, { style: styles.emptyContainer, children: /* @__PURE__ */ jsx(Text, { style: [styles.emptyText, { color: colors.placeholder }], children: emptyFilterMessage }) });
    }
    return /* @__PURE__ */ jsx(
      FlatList,
      {
        ...
        renderItem: ({ item: entry }) => {
          if (entry.type === "group") {
            return /* @__PURE__ */ jsx(View, { style: [styles.groupHeader, { backgroundColor: colors.groupBg, borderBottomColor: colors.groupBorder }], children: /* @__PURE__ */ jsx(Text, { style: [styles.groupHeaderText, { color: colors.textSecondary }], children: getLabel(entry.data, optionGroupLabel) }) });
          }
          ...
          return /* @__PURE__ */ jsxs(
            TouchableOpacity,
            {
              ...
              children: [
                ...
                itemTemplate ? itemTemplate(entry.data) : /* @__PURE__ */ jsx(Text, { style: [
                  styles.itemText,
                  { color: colors.text },
  ...
  const renderSelected = () => {
    ...
    if (display === "chip") {
      ...
      return /* @__PURE__ */ jsxs(View, { style: styles.chips, children: [
        visibleItems.map(
          (item, i) => selectedItemTemplate ? /* @__PURE__ */ jsx(React.Fragment, { children: selectedItemTemplate(item) }, i) : /* @__PURE__ */ jsxs(View, { style: [styles.chip, { backgroundColor: colors.chipBg }], children: [
            /* @__PURE__ */ jsx(Text, { style: [styles.chipText, { color: colors.chipText }], children: getLabel(item, optionLabel) }),
            /* @__PURE__ */ jsx(
              TouchableOpacity,
              {
        ...
        remaining > 0 && /* @__PURE__ */ jsx(View, { style: [styles.chipMore, { backgroundColor: colors.chipMoreBg }], children: /* @__PURE__ */ jsxs(Text, { style: [styles.chipMoreText, { color: colors.textSecondary }], children: [
          "+",
          remaining
        ] }) })
      ] });
  ...
  const panelContent = /* @__PURE__ */ jsxs(View, { style: { flex: 1 }, children: [
    /* @__PURE__ */ jsxs(View, { style: [styles.panelHeader, { borderBottomColor: colors.headerBorder }], children: [
      /* @__PURE__ */ jsxs(Text, { style: [styles.panelHeaderText, { color: colors.textSecondary }], children: [
        selectedValues.length,
        " item",
        selectedValues.length !== 1 ? "s" : "",
        " selected"
      ] }),
      /* @__PURE__ */ jsx(TouchableOpacity, { onPress: () => setOpen(false), children: /* @__PURE__ */ jsx(Text, { style: [styles.panelCloseText, { color: colors.placeholder }], children: "\u2715" }) })
    ] }),
    filter && /* @__PURE__ */ jsxs(View, { style: [styles.searchContainer, { borderColor: colors.border, backgroundColor: colors.searchBg }], children: [
      /* @__PURE__ */ jsx(Text, { style: styles.searchIcon, children: "\u{1F50D}" }),
      /* @__PURE__ */ jsx(
        TextInput,
        {
          value: query,
  ...
  return /* @__PURE__ */ jsxs(View, { style: { width: "100%" }, children: [
    /* @__PURE__ */ jsxs(
      TouchableOpacity,
      {
        activeOpacity: 0.8,
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Text, { style: [styles.dropdownArrow, { color: colors.placeholder }], children: open ? "\u25B2" : "\u25BC" })
        ]
      }
    ),
    isModal && /* @__PURE__ */ jsx(Modal, { visible: open, transparent: true, animationType: "fade", children: /* @__PURE__ */ jsx(Pressable, { style: styles.overlay, onPress: () => setOpen(false), children: /* @__PURE__ */ jsx(Pressable, { style: [styles.modalPanel, { backgroundColor: colors.bg }], onPress: () => {
    }, children: panelContent }) }) }),
    !isModal && open && /* @__PURE__ */ jsxs(View, { style: StyleSheet.absoluteFill, pointerEvents: "box-none", children: [
      /* @__PURE__ */ jsx(
        TouchableOpacity,
        {
      ...
      /* @__PURE__ */ jsx(View, { style: [styles.inlinePanel, { backgroundColor: colors.bg, borderColor: colors.border }], children: panelContent })
    ] })
  ] });
}
