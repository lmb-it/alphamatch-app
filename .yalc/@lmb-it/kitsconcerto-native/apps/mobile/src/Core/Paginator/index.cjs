...
function RowsPerPageDropdownToken({
  ...
  const element = /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { className: unstyled ? "" : "relative", ...ptDrop, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      reactNative.Pressable,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: rows || options[0] || 0 })
      }
    ),
    open && !disabled && /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { className: unstyled ? "" : "mt-2 border rounded p-2", children: options.map((opt) => /* @__PURE__ */ jsxRuntime.jsx(
      reactNative.Pressable,
      {
        accessibilityRole: "button",
        onPress: () => {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: opt })
      },
      opt
    )) })
  ] });
...
function JumpToPageInputToken({
  ...
  const [value, setValue] = React.useState(String(currentPageOne));
  React.useEffect(() => {
    ...
    pages.push(
      /* @__PURE__ */ jsxRuntime.jsx(
        reactNative.Pressable,
        {
          ...
          ...ptBtn,
          children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: p + 1 })
        },
        p
      )
    );
  }
  const defaultEl = /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { className: unstyled ? "" : "flex-row items-center gap-1", ...ptPages, children: pages });
...
const Paginator = React.forwardRef((props, ref) => {
  ...
  React.useImperativeHandle(ref, () => ({ getElement: () => rootRef.current }));
  const pageCount = React.useMemo(() => {
    if (!rows || rows <= 0) return 0;
    return Math.ceil(totalRecords / rows);
  }, [rows, totalRecords]);
  const currentPageZero = React.useMemo(() => {
    if (!rows || rows <= 0) return 0;
      ...
      case "FirstPageLink": {
        ...
        const element = /* @__PURE__ */ jsxRuntime.jsx(
          reactNative.Pressable,
          {
            ...
            ...ptBtn,
            children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: firstPageLinkIcon ?? "\u23EE" })
          }
        );
      ...
      case "PrevPageLink": {
        ...
        const element = /* @__PURE__ */ jsxRuntime.jsx(
          reactNative.Pressable,
          {
            ...
            className: unstyled ? "" : "px-2 py-1 rounded",
            ...ptBtn,
            children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: prevPageLinkIcon ?? "\u25C0" })
          }
        );
      ...
      case "NextPageLink": {
        ...
        const element = /* @__PURE__ */ jsxRuntime.jsx(
          reactNative.Pressable,
          {
            ...
            className: unstyled ? "" : "px-2 py-1 rounded",
            ...ptBtn,
            children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: nextPageLinkIcon ?? "\u25B6" })
          }
        );
      ...
      case "LastPageLink": {
        ...
        const element = /* @__PURE__ */ jsxRuntime.jsx(
          reactNative.Pressable,
          {
            ...
            className: unstyled ? "" : "px-2 py-1 rounded",
            ...ptBtn,
            children: /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { children: lastPageLinkIcon ?? "\u23ED" })
          }
        );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    reactNative.View,
    {
      ...
      ...ptRoot,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(reactNative.View, { className: baseLeftClass, ...ptLeft, children: [
          leftContent,
          layoutTokens.map((t, i) => /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: renderToken(t) }, `${t}-${i}`))
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(reactNative.View, { className: baseRightClass, ...ptEnd, children: rightContent })
      ]
    }
  );
});
