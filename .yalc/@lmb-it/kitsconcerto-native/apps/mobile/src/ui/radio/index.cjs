...
var creator = require('@gluestack-ui/core/radio/creator');
...
const SCOPE = "Radio";
const UIRadio = creator.createRadio({
...
const radioStyle = nativewindUtils.tva({
...
const radioGroupStyle = nativewindUtils.tva({
  base: "gap-2"
});
const radioIconStyle = nativewindUtils.tva({
...
const radioIndicatorStyle = nativewindUtils.tva({
...
const radioLabelStyle = nativewindUtils.tva({
