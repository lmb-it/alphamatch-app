...
function useResponsiveBuilder(props, ref) {
  ...
  const Component = COMPONENT_MAP[as] || reactNative.View ;
  ...
  const content = /* @__PURE__ */ jsxRuntime.jsx(
    Component,
    {
      ...
      children: isText ? /* @__PURE__ */ jsxRuntime.jsx(index$5.Text, { children }) : children
    }
  );
  if (scrollable) {
...
exports.default = useResponsiveBuilder;
//# sourceMappingURL=useResponsiveBuilder.cjs.map
