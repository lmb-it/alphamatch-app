...
var index$1 = require('../../apps/mobile/src/ui/skeleton/index.cjs');
...
const Skeleton = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(index.default, { ...container, children: /* @__PURE__ */ jsxRuntime.jsx(index$1.Skeleton, { className, ...props }) });
};
