...
import { Skeleton as Skeleton$1 } from '../../apps/mobile/src/ui/skeleton/index.js';
...
const Skeleton = ({
  ...
  return /* @__PURE__ */ jsx(Flex, { ...container, children: /* @__PURE__ */ jsx(Skeleton$1, { className, ...props }) });
};
