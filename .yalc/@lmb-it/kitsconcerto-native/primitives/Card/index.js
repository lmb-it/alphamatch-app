...
const Card = (rawProps) => {
  const { mergedProps: cardProps, themeStyle, elementStyles } = useComponentDefaults("Card", rawProps);
  const {
    title,
    subTitle,
    header,
  ...
  const cardElement = /* @__PURE__ */ jsx(
    ResponsiveElement,
    {
      ref,
      entering,
  ...
  if (onPress) {
    return /* @__PURE__ */ jsx(Pressable, { onPress, accessibilityRole: "button", children: cardElement });
  }
  return cardElement;
};
