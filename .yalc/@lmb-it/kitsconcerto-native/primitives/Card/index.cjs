...
var index = require('../../apps/mobile/src/ui/heading/index.cjs');
...
var index$1 = require('../../apps/mobile/src/ui/text/index.cjs');
...
const Card = (rawProps) => {
  const { mergedProps: cardProps, themeStyle, elementStyles } = useComponentDefaults.default("Card", rawProps);
  const {
    title,
    subTitle,
    header,
  ...
  const children = React.useMemo(() => {
    const ret = [];
    if (header) {
      ret.push(React.isValidElement(header) ? React.cloneElement(header, { key: "header" }) : /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: typeof header == "function" ? localProps ? header(localProps) : "" : header }, "header"));
    }
    if (title) {
      ret.push(
        /* @__PURE__ */ jsxRuntime.jsx(index.Heading, { size: "md", className: "mb-1", children: typeof title == "function" ? localProps ? title(localProps) : "" : title }, "title")
      );
    }
    if (subTitle) {
      ret.push(/* @__PURE__ */ jsxRuntime.jsx(index$1.Text, { children: typeof subTitle == "function" ? localProps ? subTitle(localProps) : "" : subTitle }, "subTitle"));
    }
    if (CardChildren) {
      ret.push(React.isValidElement(CardChildren) ? React.cloneElement(CardChildren, { key: "CardChildren" }) : /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: CardChildren }, "CardChildren"));
    }
    if (footer) {
      ret.push(React.isValidElement(footer) ? React.cloneElement(footer, { key: "footer" }) : /* @__PURE__ */ jsxRuntime.jsx(React.Fragment, { children: typeof footer == "function" ? localProps ? footer(localProps) : "" : footer }, "footer"));
    }
  ...
  const cardElement = /* @__PURE__ */ jsxRuntime.jsx(
    ResponsiveElement.default,
    {
      ...
      cssProps: { ...themeStyle, ...elementStyles.root || {}, ...cssProps },
  ...
  if (onPress) {
    return /* @__PURE__ */ jsxRuntime.jsx(reactNative.Pressable, { onPress, accessibilityRole: "button", children: cardElement });
  }
  return cardElement;
};
