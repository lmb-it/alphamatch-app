...
var GridContext = require('./GridContext.cjs');
...
const KitsGrid = ({
  ...
  const registerItem = React.useCallback((id, colSpan) => {
  ...
  const itemWidths = React.useMemo(() => {
    ...
    const rows = GridContext.arrangeIntoRows(colSpans, columns);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(GridContext.default.Provider, { value: contextValue, children: /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.View,
    {
...
exports.default = KitsGrid;
//# sourceMappingURL=KitsGrid.cjs.map
