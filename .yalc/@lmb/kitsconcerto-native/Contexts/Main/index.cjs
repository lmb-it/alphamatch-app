...
function MainContextProvider({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(MainContext.Provider, { value: { logo, onLogOut, appendToHeader, menuItems, mq }, children: /* @__PURE__ */ jsxRuntime.jsx(index.GluestackUIProvider, { mode: theme, children: /* @__PURE__ */ jsxRuntime.jsx(KitsThemeProvider_native.KitsThemeProvider, { theme: kitsTheme, children: /* @__PURE__ */ jsxRuntime.jsx(index_native.default, { theme, children: /* @__PURE__ */ jsxRuntime.jsx(
