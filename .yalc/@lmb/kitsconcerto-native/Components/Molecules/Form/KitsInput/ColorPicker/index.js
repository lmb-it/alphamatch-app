...
import { colorPickerStyle } from './colorPickerStyle.js';
...
const KitsInputColorPicker = ({ ref, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(
    KitsContainer,
    {
      ...
      disabled,
      required,
      children: /* @__PURE__ */ jsx(Addons, { leftAddon, rightAddon, children: /* @__PURE__ */ jsx(View, { style: { width: "100%" }, children: /* @__PURE__ */ jsxs(
        ColorPicker,
        {
          value: resultColor,
          sliderThickness: 25,
