...
const ErrorMessage = ({ errors, invalid }) => {
  if (!errors || !invalid) return null;
  const renderMessage = (message, index$1) => /* @__PURE__ */ jsxRuntime.jsxs(index.FormControlError, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(index.FormControlErrorIcon, { as: lucideReactNative.AlertCircleIcon, className: "text-red-500" }),
    /* @__PURE__ */ jsxRuntime.jsx(index.FormControlErrorText, { className: "text-red-500", children: message })
  ] }, index$1);
