...
import RadioIndicator from '../../../../../apps/mobile/src/Core/RadioButton/index.js';
...
const RadioButton = ({
  ...
  const size = item.size ? sizes[item.size] : sizes.md;
  const padding = item.size ? paddings[item.size] : paddings.md;
