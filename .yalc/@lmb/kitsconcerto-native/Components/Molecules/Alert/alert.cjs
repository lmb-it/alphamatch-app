...
const AlertIcon = ({ status = "info" }) => {
  ...
  const color = statusColors[status];
  return /* @__PURE__ */ jsxRuntime.jsx(index_native.Icon, { name: IconComponent, color, size: "lg" });
};
const AlertTitle = ({ children }) => /* @__PURE__ */ jsxRuntime.jsx(index_native$1.default, { fontWeight: "bold", children });
const AlertDescription = ({ children }) => /* @__PURE__ */ jsxRuntime.jsx(index_native$1.default, { size: "sm", children });
