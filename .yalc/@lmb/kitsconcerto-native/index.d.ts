...
import React__default, { ComponentType, ReactNode, ReactElement, Ref, CSSProperties, RefObject, MouseEventHandler, ElementType, JSX, ChangeEvent, FC, PropsWithChildren, FunctionComponent, Dispatch, SetStateAction } from 'react';
import * as react_jsx_runtime from 'react/jsx-runtime';
import * as react_native from 'react-native';
import { ViewStyle, ColorValue as ColorValue$1, ViewProps, TextProps as TextProps$1, ImageProps, Text as Text$1, ScrollViewProps, GestureResponderEvent, NativeSyntheticEvent, TextInputKeyPressEventData, TargetedEvent, NativeScrollEvent, StyleProp } from 'react-native';
...
// ─── Inlined core types (originally from @lmb/kitsconcertomobile) ────
 ...
 *
 * These types have ZERO platform-specific imports (no primereact, no @lmb/kitsconcertomobile).
...
// ─── Inlined tree types (originally from @lmb/kitsconcertomobile) ────
